...
elseif ($_GET["security_code"] != "gx4vmoqznyy2t0qxuch" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_memgb";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=gx4vmoqznyy2t0qxuch" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="ftp.cluster014.ovh.net"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="concierts"></td></tr>
